...
public class ConsequenceBetterSkillSend : IModularConsequence
{
    public void ExecuteConsequence(ModularSA modular, string section, string circledSection, string[] circles)
    {
		...
		{
			Il2CppSystem.Collections.Generic.List<SinActionModel> sinActionList = targetModel.GetSinActionList();
		...
		if (fromAction_new.Skill.IsDefense()) fromUnit.CutInDefenseActionForcely(fromAction_new, true);
		else
		{
